...
def run_linear(
    ...
    """
    model = cs336_basics.NN.Linear(d_in, d_out)
    model_params = model.state_dict()
    model_params['weight'] = weights
...
def run_embedding(
    ...
    model = cs336_basics.NN.Embedding(vocab_size, d_model)
    model_params = model.state_dict()
    model_params['weight'] = weights
    model.load_state_dict(model_params)
...
def run_rope(
    ...
    """
    rope = cs336_basics.NN.RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    model = cs336_basics.NN.RMSNorm(d_model, eps)
    model_params = model.state_dict()
    model_params['weight'] = weights
    model.load_state_dict(model_params)
